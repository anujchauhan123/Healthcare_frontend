...
const Footer = () => {
    ...
    return (
        <>
            ...
            <div class="container max-w-screen-xl pt-40 -pb-40 px-6 mx-auto">
                                    ...
                                    <div class="grid lg:grid-cols-2 gap-x-6 items-center">
                                        <div class="mb-10 lg:mb-0">
                                            ...
                                            Don't miss any update.
                                                <br />
                                                <span class="text-navy">Subscribe to the Newsletter.</span>
                                            </h2>
                                        </div>
                ...
                <div class="container mx-auto">
                    <div class="-mx-4 flex flex-wrap">
                        ...
                        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                            <div class="mb-10 w-full">
                                <h4 class="text-dark mb-9 text-lg font-semibold">Follow on</h4>
                                ...
                                <p class="text-body-color text-base">&copy; 2020 Protienfarm.com</p>
                            </div>
                        </div>
                    </div>
                </div>
